...
message("Number of FPCs K: ", args[4])
...
V_out = data.frame(Method = c(), Spread = c(), Sample = c(), K = c())
FE_out = data.frame(Method = c(), Mean_Cov = c(), MSE = c(), Sample = c(), K = c())
EF_out = data.frame(Method = c(), EFNum = c(), Mean_Cov = c(), MSE = c(), Sample = c(), K = c())
Score_out = data.frame(Method = c(), EFNum = c(), Mean_cov = c(), MSE = c(), Sample = c(), K = c())
